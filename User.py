...
class User(tk.Frame):  # This is the user windows
    ...
    def __init__(self, parent, controller):
        ...
        def buttons(self):  # These are the buttons for the game
            button1 = tk.Button(self, text="", width=5, height=2, command=lambda: toggle_text1(button1))
            button1.place(relx=.3, rely=.2, anchor="center")

            button2 = tk.Button(self, text="", width=5, height=2, command=lambda: toggle_text1(button2))
            button2.place(relx=.5, rely=.2, anchor="center")

            button3 = tk.Button(self, text="", width=5, height=2, command=lambda: toggle_text1(button3))
            button3.place(relx=.7, rely=.2, anchor="center")

            button4 = tk.Button(self, text="", width=5, height=2, command=lambda: toggle_text1(button4))
            button4.place(relx=.3, rely=.4, anchor="center")

            button5 = tk.Button(self, text="", width=5, height=2, command=lambda: toggle_text1(button5))
            button5.place(relx=.5, rely=.4, anchor="center")

            button6 = tk.Button(self, text="", width=5, height=2, command=lambda: toggle_text1(button6))
            button6.place(relx=.7, rely=.4, anchor="center")

            button7 = tk.Button(self, text="", width=5, height=2, command=lambda: toggle_text1(button7))
            button7.place(relx=.3, rely=.6, anchor="center")

            button8 = tk.Button(self, text="", width=5, height=2, command=lambda: toggle_text1(button8))
            button8.place(relx=.5, rely=.6, anchor="center")

            button9 = tk.Button(self, text="", width=5, height=2, command=lambda: toggle_text1(button9))
